...
import {FavoriteRedIcon} from '../../assets/icons/icons';
import {
...
interface YogaCardFavoriteProps {
  title: string;
  duration: string;
  YogaImage: any;
  onPress: () => void;
...
const YogaCardFavorite = ({
  title,
  YogaImage,
  duration,
  onPress,
  level,
}: YogaCardFavoriteProps) => {
  return (
    <TouchableOpacity
      onPress={onPress}
      style={{
...
export default YogaCardFavorite;
